        ...
        <div>
            ...
            <Row style={{ display: 'flex', width: '100%' }}>
                <Col style={{ width: '100%', paddingTop: 15 }} md={12} sm={24}>
                    ...
                    <SearchInput getSuccessData={data => setPlayerOneName(data)} otherName={playerTwoName} />

                </Col>

                <Col style={{ width: '100%', paddingTop: 15 }} md={12} sm={24}>
                    <p style={{ fontSize: 24, fontWeight: 'bold' }}>Player Two</p>
                    <SearchInput getSuccessData={data => setPlayerTwoName(data)} otherName={playerOneName} />
                </Col>
            </Row>
