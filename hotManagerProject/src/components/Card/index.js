...
function Index(props) {
    ...
    const changeNumber = (number) => (number || 0).toString().replace(/(\d)(?=(?:\d{3})+$)/g, '$1,');

    return (
        <div className={styles.warpper} style={{ backgroundColor: 'rgb(235,235,235)' }} >
            ...
            <div className={styles.infoWrapper} >
                ...
                <div style={{ textAlign: 'left' }}>
                    <i className="fa fa-share-alt fa-rotate-270" style={{ color: 'rgb(147,201,242)' }} />
